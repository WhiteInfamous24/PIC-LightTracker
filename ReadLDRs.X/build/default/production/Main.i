...
main:
    ...
    BCF PORTB, 0
    BTFSS STATUS, 0 ; if the result is positive or zero, turn on the LED in ((PORTB) and 07Fh), 0
    BSF PORTB, 0
    BTFSC STATUS, 0 ; if the result is negative, turn on the LED on ((PORTB) and 07Fh), 1
    BSF PORTB, 1
    BTFSS STATUS, 0 ; if the result is positive or zero, turn on the LED in ((PORTB) and 07Fh), 0
    BCF PORTB, 1
